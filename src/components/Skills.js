...
function Skills() {
  ...
  return (
    <section id="skills" style={{ margin: '15px', display: "flex", alignItems: "center", flexDirection: "column" }}>
      ...
      <div>
        <img src={Skill_1} alt="Skill 1" style={{ marginLeft: '10px', marginRight: '10px', width: '30%' }}/>
        <img src={Skill_3} alt="Skill 3" style={{ width: '30%' }}/>
        <img src={Skill_2} alt="Skill 2" style={{ marginLeft: '10px', marginRight: '10px', width: '30%' }}/>
      </div>
    </section>
