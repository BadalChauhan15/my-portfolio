...
function About() {
  ...
  return (
    <section id="about" style={{ 
      ...
      <a href='https://drive.google.com/uc?export=download&id=1Y5nu7viFmAYYIDlTqWUGiavqleeUvkkt' style={{textDecoration: 'none', alignSelf: 'flex-start', marginTop: '15px', borderRadius: "5px", backgroundColor: "#27ae60", color: "white", border: "none", padding: '10px 20px',cursor: 'pointer', transition: 'background-color 0.3s ease', "hover": { backgroundColor: '#adb5bd'} }}>
        Download Resume
      </a>
    </section>
  );
